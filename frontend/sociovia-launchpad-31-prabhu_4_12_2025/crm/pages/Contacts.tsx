                        ...
                        {loading ? (
                            ...
                            filteredContacts.map((contact) => (
                                <div
                                    ...
                                    className="group grid grid-cols-12 gap-4 p-4 items-center border-b border-slate-50 hover:bg-slate-50 cursor-pointer transition-colors"
                                >
                                    {/* Name Column */}
                                    ...
                                    <div className="col-span-3 flex flex-col justify-center">
                                        ...
                                        {!contact.role && !contact.company && <span className="text-xs text-slate-400">-</span>}
                                    </div>

                                    {/* Actions Column */}
                                    <div className="col-span-2 flex items-center justify-end gap-2 pr-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button
